...
- Fixed decoding of OTLP/JSON traceId/spanId as hex, improving trace accuracy.
- Reduced Microsoft Graph scopes for Office tools, enhancing security.
...
- Fixed decoding of OTLP/JSON traceId/spanId to use hex format, improving tracing compatibility.
- Reduced Microsoft Graph scopes for Office tools, enhancing security and compliance.
