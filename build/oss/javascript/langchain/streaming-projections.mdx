...
For most application and frontend use cases, use **Projection Streaming** through `stream_v2()`. Projection Streaming returns a run object with typed projections, so you can choose the view you need instead of parsing stream-mode tuples.

<Note>
Interested in streaming Pregel modes such as `updates`, `messages`, or `custom` directly? See the [Mode Streaming page](/oss/javascript/langchain/streaming).
</Note>
...
- [Mode Streaming](/oss/javascript/langchain/streaming) covers low-level Pregel stream modes.
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/streaming-projections.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
