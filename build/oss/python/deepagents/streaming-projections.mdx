...
<Note>
Interested in lower-level Pregel stream modes and the existing Deep Agents streaming guide? See the [Mode Streaming page](/oss/python/deepagents/streaming).
</Note>
...
- [LangChain streaming projections](/oss/python/langchain/streaming-projections) covers general agent message and tool-call streaming concepts.
...
- [LangGraph Projection Streaming](/oss/python/langgraph/streaming/projection-streaming) covers the underlying graph streaming model.
