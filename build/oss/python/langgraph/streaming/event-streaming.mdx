...
For product-specific streams, see [Deep Agents streaming](/oss/python/deepagents/streaming-projections) for subagent streams and [LangChain agent streaming](/oss/python/langchain/streaming) for tool calls and middleware events.
