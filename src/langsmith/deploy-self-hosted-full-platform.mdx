...
<Info>
Fleet requires [LangSmith Self-Hosted v0.13](https://changelog.langchain.com/announcements/langsmith-self-hosted-v0-13) or later. The standalone deployment model described below (with dedicated Postgres and Redis per feature) requires v0.15 or later.
</Info>
