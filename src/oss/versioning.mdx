...
pip install langchain-core=={{LANGCHAIN_CORE_PY_VERSION}}
```
...
# Upgrade to a specific version
pip install langgraph=={{LANGGRAPH_PY_VERSION}}
```
...
# Upgrade to a specific version
pip install deepagents=={{DEEPAGENTS_PY_VERSION}}
```
</CodeGroup>
:::
...
npm install langchain@{{LANGCHAIN_JS_VERSION}} @langchain/core@{{LANGCHAIN_CORE_JS_VERSION}}
```
...
# Install a specific version
npm install @langchain/langgraph@{{LANGGRAPH_JS_VERSION}}
```
</CodeGroup>
:::
